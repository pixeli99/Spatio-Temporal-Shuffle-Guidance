...
from stsg_utils import STSGMixin
...
class StableVideoDiffusionSTSGipeline(DiffusionPipeline, STSGMixin):
    r"""
    ...
    def __init__(
        ...
        stsg_applied_layers: Union[str, List[str]] = ["mid", "up.block_1"],  # ["mid"],["down.block_1"],["up.block_0.attentions_0"]
    ):
        super().__init__()
        ...
        self.set_stsg_applied_layers(stsg_applied_layers)
    ...
    def __call__(
        ...
        self._set_stsg_attn_processor(
            stsg_applied_layers=self.stsg_applied_layers,
        )
